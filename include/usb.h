...
#define USB_DESC_CONFIGURATION  2       /* Configuration descriptor */
...
/* Device Management */
int usb_enumerate_device(usb_hci_t* hci, uint8_t port);
...
int usb_set_interface(usb_device_t* device, uint8_t interface, uint8_t alt_setting);
...
/* String Operations */
int usb_get_string_descriptor(usb_device_t* device, uint8_t index,
